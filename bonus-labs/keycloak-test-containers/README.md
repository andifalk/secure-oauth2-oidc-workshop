...
To change the issuer and jwks uri, we dynamically override the oauth2 resource server configuration using _DynamicPropertyRegistry_ instance, and the @DynamicPropertySource spring test support.
